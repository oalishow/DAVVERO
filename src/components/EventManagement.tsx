              ...
              >
                ...
                <div className="mt-4 flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 px-4 py-2 sm:py-3 rounded-xl w-full sm:w-auto">
                  ...
                  <div className="flex flex-wrap bg-slate-100 dark:bg-slate-800 rounded-lg p-1 gap-1">
                    ...
                    >
                      <Search className="w-3.5 h-3.5" /> Inscritos
                    </button>
                    <button
                      onClick={() => setShowCertificateEditor(event)}
                      className="flex-1 sm:flex-none flex items-center justify-center gap-1.5 px-3 py-1.5 hover:bg-white dark:hover:bg-slate-700 text-indigo-600 dark:text-indigo-400 text-xs font-bold rounded-md transition-colors"
                    >
                    ...
                    {event.status === "aberto" && (
                      <button
                        ...
                        className="flex-1 sm:flex-none flex items-center justify-center gap-1.5 px-3 py-1.5 hover:bg-white dark:hover:bg-slate-700 text-sky-600 dark:text-sky-400 text-xs font-bold rounded-md transition-colors"
                      >
